        ...
        @if (!$user_login_status)
            <nav class="navbar navbar-inverse">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="{{ Url('/sign-up') }}"><span class="glyphicon glyphicon-user"></span> Sign Up</a>
                        </li>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="destination_station" class="form-control" required>
                                            <option value="select" disabled selected>Destination city</option>
                                            @foreach ($destination_stations as $station)
                                                <option value="{{ $station }}">{{ $station }}</option>
                                            @endforeach
                                        </select>
                                    </div>
